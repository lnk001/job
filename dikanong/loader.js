(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_57c79a67524e34320400098d")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '56f93007a3664ee918000387';
_mrmcp['creative_id'] = '57c79a67524e34320400098d';
...
_mrmcp['title'] = '迪卡侬';
_mrmcp['track_bot'] = '';
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '_0.7.90';
var w = _mrmcp['width'];
var h = _mrmcp['height'];
...
var loadProcessHandleInstance = Mugeda['loadProcessHandleInstance'] = new Mugeda['loadProcessHandle']['bar']({
    'loadInfo': JSON.parse("{\"style\":\"bar\",\"messageText\":\"\",\"logoImage\":\"57c7cd11524e342b04001649.png\",\"progressPosition\":\"35\",\"backgroundImage\":\"57c7cd11524e34440400163f.png\",\"logoWidth\":\"100\",\"backgroundColor\":\"rgba(191, 237, 245, 1)\"}"),
    'thisAni': {
        'dom': null
    },
    'stageDom': stageDom
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(0, "mugeda_utils" + version + ".js", [0]);
        loadRes(1, that.crid + ".js?publishTime=1473434962462", []);
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1473434962462" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
