(function () {
    ...
    var stageDom = document.getElementById("Mugeda_571499bea3664e0f130000e5")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '56f93007a3664ee918000387';
_mrmcp['creative_id'] = '571499bea3664e0f130000e5';
...
_mrmcp['title'] = '沪江开心词场';
_mrmcp['track_bot'] = '';
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '_0.6.29';
var w = _mrmcp['width'];
var h = _mrmcp['height'];
...
Mugeda.loadProcessHandle.bar.prototype.init = function () {
    ...
    var html = '<div style="z-index:20;position:absolute;top:0;width:100%;height:100%;background:' + backStr + ';background-repeat:no-repeat;background-size:' + (Mugeda.isMobile ? 'cover' : 'contain')+';">' +
...
var loadProcessHandleInstance = Mugeda['loadProcessHandleInstance'] = new Mugeda['loadProcessHandle']['bar']({
    'loadInfo': JSON.parse("{\"style\":\"bar\",\"backgroundImage\":\"\",\"logoImage\":\"571499ffa3664e9f13000143.png\",\"messageText\":\"\"}"),
    'thisAni': {
        'dom': null
    },
    'stageDom': stageDom
